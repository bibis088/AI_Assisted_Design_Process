...
## Déclenchement automatique — principes UX

À la fin de `write-specs`, déclencher automatiquement `write-ux-principles-flows` sur les FLUX-### produits.
Ce skill évalue les flux contre les heuristiques Nielsen H1/H3/H5/H9 et la loi de Miller.
Il est non bloquant — le Product Designer priorise les corrections mais Gate 1 n'est pas stoppée.
